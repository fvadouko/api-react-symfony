...
class Customer
{
     ...
     * @Assert\Length(
     *      min = 3,
     *      minMessage = "Le prénom doit être de plus de 3 caractères"
     * )
     *
     */
    private $firstname;
     ...
     * @Assert\Length(
     *      min = 3,
     *      minMessage = "Le nom doit être de plus de 3 caractères"
     * )
     */
    private $lastname;
    ...
    /**
     * get total of amount of invoices
     * 
     * @Groups({"customers_read"})
     *
     * @return float
    ...
    /**
     * get total of unpaid amount of invoices
     * 
     * @Groups({"customers_read"})
     *
     * @return float
